...
Core_author = "©2026 GabE=mc² — Gabriel Martín del Campo F. & Jazmín Olvera Zacarias"
...
# Speed of light in vacuum (defined constant)
...
# It does NOT alter the physics of the DK-RD2 model; it only shifts
